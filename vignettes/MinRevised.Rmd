...
**'dbCreateDB'** is a function to connect to the local database file. This is the pre-configuration before saving data in database.
...
```r
cron_create("DSM", "DTW", "2019-06-01", frequency = "hourly")
